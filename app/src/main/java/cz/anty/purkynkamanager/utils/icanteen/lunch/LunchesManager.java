package cz.anty.purkynkamanager.utils.icanteen.lunch;
...
public class LunchesManager {
    ...
    public synchronized void apply() {
        context.getSharedPreferences(Constants.SETTINGS_NAME_LUNCHES, Context.MODE_PRIVATE).edit()
                .putString(Constants.SETTING_NAME_MONTH_LUNCHES, lunchesToString(getMonthLunches()))
                .apply();
    }

    @Override
    public String toString() {
        return lunchesToString(getMonthLunches());
    }

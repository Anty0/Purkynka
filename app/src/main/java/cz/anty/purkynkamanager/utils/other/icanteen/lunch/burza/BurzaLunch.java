...
public class BurzaLunch implements MultilineItem {
    ...
    public CharSequence getTitle(Context context, int position) {
        return DATE_FORMAT.format(getDate()) + " - " + getPieces() + " x " + getLunchNumber().toText(context);
    }
    ...
    public enum LunchNumber {
        ...
        public CharSequence toText(Context context) {
            switch (this) {
                case LUNCH_3:
                    return context.getText(R.string.text_lunch) + " 3";
                case LUNCH_2:
                    return context.getText(R.string.text_lunch) + " 2";
                case LUNCH_1:
                default:
                    return context.getText(R.string.text_lunch) + " 1";
            }
        }
